document.addEventListener("DOMContentLoaded", () => {
    ...
    // Mensaje según la sección general que se está mirando
    ...
    // Mensaje específico según la pestaña activa dentro de "Soluciones Especializadas"
    ...
    const actualizarWhatsappPorSeccion = (idSeccion) => {
        ...
        // Si la sección de soluciones especializadas tiene una tab activa, ese mensaje tiene prioridad
    ...
    if (botonWhatsapp) {
        ...
        const whatsappObserver = new IntersectionObserver((entries) => {
            // Entre las secciones visibles, tomamos la que ocupa más espacio en pantalla
    ...
    if (formulario) {
        ...
        formulario.addEventListener('submit', async (e) => {
            ...
            if (!telefono) return true; // si el teléfono es opcional, vacío está permitido

            const telefonoLimpio = telefono.replace(/[^\d]/g, ''); // deja solo números
